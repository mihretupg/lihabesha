...
def upgrade() -> None:
    ...
    op.drop_constraint('moderation_actions_actor_id_fkey', 'moderation_actions', type_='foreignkey')
    op.drop_constraint('moderation_actions_target_post_id_fkey', 'moderation_actions', type_='foreignkey')
    ...
    op.create_foreign_key('moderation_actions_actor_id_fkey', 'moderation_actions', 'users', ['actor_id'], ['id'])
    op.create_foreign_key('moderation_actions_target_post_id_fkey', 'moderation_actions', 'posts', ['target_post_id'], ['id'])
    op.create_foreign_key('reports_post_id_fkey', 'reports', 'posts', ['post_id'], ['id'])
